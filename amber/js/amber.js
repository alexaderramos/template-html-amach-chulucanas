...
$(document).ready(function() {
    ...
    $(".btn-update-item").on('click',function(e) {
        ...
        var id=$(this).data('id');
        var precio= $(this).parent().parent().find('td.precio').text();
        var cantidad= $(this).parent().parent().find('input[name=cant]').val();
        var subtotal= $(this).parent().parent().find('td.subtotal');
        var sub=0;
        if(precio != undefined && cantidad !=undefined){
            sub=precio*cantidad;
            subtotal.text(sub);
